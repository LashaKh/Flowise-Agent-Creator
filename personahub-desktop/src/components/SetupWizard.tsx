  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-400">Sign in with your PersonaHub account.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          ...
          <input
            ...
            disabled={loading}
            className="w-full bg-gray-900 border border-gray-800 rounded-lg px-4 py-3 text-sm text-white placeholder-gray-500 focus:border-indigo-500 focus:outline-none disabled:opacity-50"
          />
        </div>
        <div className="space-y-2">
        ...
        <button
          ...
          className="w-full py-3 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-500 disabled:opacity-40 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
        >
      ...
      <p className="text-center text-xs text-gray-500">
        ...
        <a href="https://magic-bots.netlify.app" target="_blank" rel="noreferrer" className="text-indigo-400 hover:text-indigo-300">
          magic-bots.netlify.app
        </a>
      </p>
    </div>
  );
