...
function EmptyState() {
  return (
    <div className="text-center py-12">
      <div className="inline-flex items-center justify-center w-16 h-16 bg-white/10 border border-white/10 rounded-full mb-4">
        <svg
      ...
      <h3 className="text-lg font-display font-medium text-white mb-1">No personas created yet</h3>
      <p className="text-gray-400 font-body">Create your first AI persona to get started.</p>
    </div>
  );
}
